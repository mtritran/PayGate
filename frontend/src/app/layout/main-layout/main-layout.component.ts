...
@Component({
      ...
      <mat-sidenav mode="side" opened class="sidenav">
        ...
        <div class="nav-wrapper">
          ...
          <mat-nav-list class="custom-nav-list">
            ...
            <a mat-list-item routerLink="/accounts/dashboard" routerLinkActive="active" [routerLinkActiveOptions]="{exact: true}">
      ...
      <mat-sidenav-content class="main-content-area">
        ...
        <div class="top-header-bar">
          ...
          <div class="header-user-info">
            ...
            <div class="user-avatar" (click)="authService.logout()" title="Click to logout">
  ...
  styles: [`
    ...
    .user-avatar { width: 32px; height: 32px; background-color: #047857; color: #ffffff; border-radius: 50%; font-size: 0.75rem; font-weight: 700; display: flex; align-items: center; justify-content: center; cursor: pointer; }
