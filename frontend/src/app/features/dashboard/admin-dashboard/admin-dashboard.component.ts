...
@Component({
    ...
    <div class="console-dashboard fade-in-up">
      ...
      <div class="welcome-header">
        ...
        <div class="header-action-buttons">
          ...
          <a class="btn-primary-gradient pulse-glow" routerLink="/admin/ledger">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div *ngIf="loading" class="skeleton-admin">
        <div class="sk-metrics-grid">
          <div *ngFor="let _ of [1,2,3,4]" class="skeleton" style="height:120px; border-radius:16px"></div>
        </div>
        <div class="sk-quick-nav">
          <div class="skeleton skeleton-title" style="width:200px"></div>
          <div class="sk-nav-grid">
            <div *ngFor="let _ of [1,2,3]" class="skeleton" style="height:140px; border-radius:16px"></div>
          </div>
        </div>
      </div>
      ...
      <div *ngIf="!loading" class="dashboard-body">
        ...
        <div class="metrics-grid stagger-children">
          ...
          <div class="metric-card hover-lift">
            ...
            <div class="metric-value" [class.text-pink]="ledgerBalanced" [class.text-red]="!ledgerBalanced">
  ...
  styles: [`
    ...
    /* ===== SKELETON ===== */
    .skeleton-admin { display:flex; flex-direction:column; gap:24px; }
    .sk-metrics-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:16px; }
    .sk-quick-nav { display:flex; flex-direction:column; gap:12px; }
    .sk-nav-grid { display:grid; grid-template-columns:repeat(3,1fr); gap:16px; }
    ...
    .btn-primary-gradient:hover { transform: translateY(-1.5px); box-shadow: 0 6px 16px rgba(194, 0, 103, 0.35); }
    ...
    .metric-card:hover {
      ...
      box-shadow: 0 8px 24px -5px rgba(194, 0, 103, 0.08);
      border-color: #f8bbd0;
    }
    ...
    .metric-icon-bg.pink { background: #fff0f6; color: #c20067; }
    .metric-icon-bg.blue { background: #eef6ff; color: #0072ce; }
    ...
    .metric-value.text-pink { color: #c20067; }
    .metric-value.text-red { color: #dc2626; }
    .metric-value.text-amber { color: #d97706; }
    .metric-value.text-blue { color: #0072ce; }

    .metric-footer { font-size: 0.75rem; margin-top: 6px; }
    .metric-footer.success { color: #c20067; font-weight: 700; }
    ...
    .nav-card:hover {
      ...
      box-shadow: 0 8px 24px -5px rgba(194, 0, 103, 0.12);
    }
    ...
    .nav-card-icon-box.pink { background: #fff0f6; color: #c20067; }
    .nav-card-icon-box.blue { background: #eef6ff; color: #0072ce; }
    .nav-card-icon-box svg { width: 22px; height: 22px; }

    .nav-card-arrow { width: 18px; height: 18px; color: #94a3b8; transition: transform 0.2s; }
    .nav-card:hover .nav-card-arrow { transform: translateX(4px); color: #c20067; }
