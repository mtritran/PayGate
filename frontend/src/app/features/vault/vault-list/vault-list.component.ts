...
@Component({
  ...
  styles: [`
    ...
    h1 { margin: 8px 0 10px; max-width: 760px; font-size: clamp(2rem, 4vw, 3.6rem); line-height: 1.04; color: #2b1238; letter-spacing: 0; }
    .hero-copy p { margin: 0; max-width: 560px; color: #6b3b57; font-size: 1rem; line-height: 1.65; }
    .hero-actions { display: flex; flex-wrap: wrap; align-items: center; gap: 12px; margin-top: 24px; }
    .primary-btn { display: inline-flex; justify-content: center; align-items: center; min-height: 46px; border: 0; border-radius: 14px; background: linear-gradient(135deg, #e91e63, #b5179e); color: white; padding: 12px 20px; font-weight: 900; text-decoration: none; box-shadow: 0 12px 26px rgba(233, 30, 99, .28); cursor: pointer; }
    .soft-pill { display: inline-flex; align-items: center; min-height: 38px; border-radius: 999px; padding: 8px 14px; background: rgba(255,255,255,.72); color: #8a1f57; font-weight: 800; border: 1px solid rgba(244,114,182,.22); }
    ...
    .stat-tile span { display: block; color: #7b5870; font-weight: 800; font-size: .83rem; margin-bottom: 8px; }
    .stat-tile strong { color: #32162f; font-size: clamp(1.1rem, 2vw, 1.45rem); }
    ...
    .empty-state h2 { margin: 0; font-size: 1.8rem; color: #2b1238; }
    .empty-state p { margin: 0; max-width: 460px; color: #7b5870; line-height: 1.55; }
    ...
    h3 { margin: 18px 0 6px; color: #2b1238; font-size: 1.22rem; line-height: 1.25; }
    .vault-card p { margin: 0; color: #7b5870; min-height: 44px; line-height: 1.45; }
    .status { border-radius: 999px; padding: 6px 10px; background: #fff1f7; color: #be185d; font-size: .72rem; font-weight: 900; white-space: nowrap; }
    .status.done { background: #dcfce7; color: #15803d; }
    .status.closed { background: #f1f5f9; color: #64748b; }
    .money-row { align-items: flex-end; margin-top: auto; padding-top: 18px; }
    .money-row strong { color: #be185d; font-size: 1.34rem; line-height: 1.1; }
    .money-row span { color: #7b5870; font-size: .82rem; font-weight: 800; text-align: right; }
    ...
    .meta-row, .over-target { color: #7b5870; font-size: .82rem; font-weight: 800; }
    .over-target { margin-top: 8px; color: #be185d; }
