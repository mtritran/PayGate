...
@Component({
  ...
  styles: [`
    ...
    .preview-amount { display: flex; justify-content: space-between; gap: 14px; align-items: flex-end; border-radius: 18px; padding: 16px; background: rgba(255,255,255,.85); border: 1px solid rgba(216,27,96,.25); }
