...
class CheckoutControllerTest {
        ...
        void createCheckoutSession_Success() throws Exception {
                CheckoutCreateRequest request = new CheckoutCreateRequest(
                                "gp_live_key_123", "ORD-1001", new BigDecimal("250000"), "Desc", "http://localhost:3000/success", null);

                CheckoutCreateResponse mockData = new CheckoutCreateResponse(
                                "CHK_TOKEN123", "http://localhost:4201/checkout?token=CHK_TOKEN123", LocalDateTime.now().plusMinutes(15));
        ...
        void createCheckoutSession_InvalidApiKey() throws Exception {
                CheckoutCreateRequest request = new CheckoutCreateRequest(
                                "invalid-key", "ORD-1001", new BigDecimal("250000"), "Desc", "http://localhost:3000/success", null);
        ...
        void createCheckoutSession_InactiveMerchant() throws Exception {
                CheckoutCreateRequest request = new CheckoutCreateRequest(
                                "inactive-key", "ORD-1001", new BigDecimal("250000"), "Desc", "http://localhost:3000/success", null);
        ...
        void createCheckoutSession_InvalidAmount_returns400() throws Exception {
                CheckoutCreateRequest request = new CheckoutCreateRequest(
                                "gp_live_key_123", "ORD-1001", new BigDecimal("500"), "Desc", "http://localhost:3000/success", null);
